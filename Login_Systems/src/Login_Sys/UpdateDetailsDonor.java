...
public class UpdateDetailsDonor extends JFrame {
    ...
    public UpdateDetailsDonor() {
        ...
        JLabel lblNewLabel = new JLabel("Update Donor ");
        ...
        btnNewButton_1.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    String query = "UPDATE donor SET UserType=?,Name=?, FatherName=?, MotherName=?, DOB=?, MobileNo=?, Gender=?, Email=?, BloodGroup=?, City=?, Address=?, UpdatedAt=? WHERE DonorId=?";
                    ...
                    pst.setString(13, DonorId); // Corrected index for DonorId
                    pst.executeUpdate();
