...
public class deleteDonor extends JFrame {
    ...
    public deleteDonor() {
        ...
        try {
            ...
            con.prepareStatement("select max(DonorId) from donor");
        } catch (Exception m) {
        ...
        textField.setBounds(292, 81, 130, 33);
        ...
        btnNewButton.setBounds(477, 80, 116, 35);
        ...
        lblNewLabel_10.setBounds(510, 169, 58, 19);
        ...
        lblNewLabel_12.setBounds(491, 202, 140, 20);
        ...
        textField_5.setBounds(641, 168, 183, 20);
        contentPane.add(textField_5);
        textField_5.setColumns(10);

        textArea = new JTextArea();
        textArea.setFont(new Font("Monospaced", Font.BOLD, 14));
        textArea.setBounds(641, 201, 183, 114);
        ...
        JButton btnNewButton_1 = new JButton("Delete donor");
        ...
        btnNewButton_1.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                String DonorId = textField.getText();
                try {
                    PreparedStatement pst = con.prepareStatement("delete from donor where DonorId=?");
        ...
        btnNewButton_1.setBounds(39, 421, 165, 33);
        ...
        btnNewButton_2.setBounds(325, 421, 109, 33);
        ...
        btnNewButton_3.setBounds(677, 421, 102, 33);
